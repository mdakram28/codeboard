...
module.exports.codeExtension = "cpp";
module.exports.compiledExtension = "exe";

module.exports.compile = function(filePath,cwd,callback){
    processMan.newProcess("g++",[filePath],"",5000,cwd,function(err,timeout,code,stdout,stderr){
...
module.exports.execute = function(filePath,cwd,testcase,callback){
    ...
    processMan.newProcess("a.exe",[],testcase,2000,cwd,function(err,timeout,code,stdout,stderr){
        if(err)return callback(err);
        if(timeout)return callback(false,"tle","");
        if(code !== 0 && stderr!=''){ //error
            return callback(false,stderr,stdout);
